...
# Запись в файл
models.to_csv(f'{start_part}//data//models.txt', index=False, sep=';')
...
with open(f'{start_part}//data//models.txt', mode='r', encoding='utf-8', newline='') as models_f:
    lines = models_f.readlines()

with open(f'{start_part}//data//models.txt', mode='w', encoding='utf-8', newline='') as models_f:
    for line in lines:
...
# Запись в файл
model_indexed_row_order[['key','index']].to_csv(f'{start_part}//data//models_index.txt', index=False, sep=';')
...
with open(f'{start_part}//data//models_index.txt', mode='r', encoding='utf-8') as models_f:
    lines = models_f.readlines()

with open(f'{start_part}//data//models_index.txt', mode='w', encoding='utf-8', newline='') as models_f:
    for line in lines:
        models_f.write(line.strip().ljust(200-1)+'\n')
...
cars.to_csv(f'{start_part}//data//cars.txt', sep=';', index=False)
...
with open(f'{start_part}//data//cars.txt', mode='r', encoding='utf-8') as cars_f:
    lines = cars_f.readlines()

with open(f'{start_part}//data//cars.txt', mode='w', encoding='utf-8', newline='') as cars_f:
    for line in lines:
...
cars_indexed_row_order[['key','index']].to_csv(f'{start_part}//data//cars_index.txt', index=False, sep=';')
...
with open(f'{start_part}//data//cars_index.txt', mode='r', encoding='utf-8') as cars_f:
    lines = cars_f.readlines()

with open(f'{start_part}//data//cars_index.txt', mode='w', encoding='utf-8', newline='') as cars_f:
    for line in lines:
        cars_f.write(line.strip().ljust(200-1)+'\n')
...
sales.to_csv(f'{start_part}//data//sales.txt',sep=';', index=False)
...
with open(f'{start_part}//data//sales.txt', mode='r', encoding='utf-8') as sales_f:
    lines = sales_f.readlines()

with open(f'{start_part}//data//sales.txt', mode='w', encoding='utf-8', newline='') as sales_f:
    for line in lines:
...
sales_index.to_csv(f'{start_part}//data//sales_index.txt', sep=';', index=False)
...
with open(f'{start_part}//data//sales_index.txt', mode='r', encoding='utf-8') as sales_f:
    lines = sales_f.readlines()

with open(f'{start_part}//data//sales_index.txt', mode='w', encoding='utf-8', newline='') as sales_f:
    for line in lines:
        sales_f.write(line.strip().ljust(200-1)+'\n')
